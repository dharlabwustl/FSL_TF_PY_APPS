...
normalized_fixed_file_name=/software/COLIHM620406202215542.nii.gz
moving_image_filename_mrigray=$(ls ${working_dir_1}/*bfc.nii*) #/software/mritemplate1/original/'BCI-DNI_brain_bfc.nii.gz'
moving_image_filename_mrigray_norm=${moving_image_filename_mrigray}
...
moving_image_filename_mrilabel=$(ls ${working_dir_1}/*label*.nii*) #/software/mritemplate1/original/'BCI-DNI_brain_label.nii.gz'  #${output_directory}/${session_ct_bname_noext}_resaved_infarct_auto_removesmall.nii.gz
#############################
...
snipr_output_foldername='PREPROCESS_LINR_1'
