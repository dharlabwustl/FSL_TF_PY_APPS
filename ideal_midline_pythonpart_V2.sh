...
OUTPUT_DIRECTORY=/input1 #${output_directory}
...
run_fit_line_to_midlinepixels_ORF_sh "$GRAYSCALENIFTI_FILE" $TRANSFORMED_MASK_DIRECTORY/$transformed_output_file  "$OUTPUT_DIRECTORY"  "${method_type_name}"
